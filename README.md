...
Terraform과 Ansible을 활용하여 AWS 환경에 K3s 기반 Kubernetes 클러스터를 자동 구축하고 GitHub Actions 기반 CI/CD 및 모니터링 환경을 구축한 프로젝트

**Tech Stack**

AWS · Terraform · Ansible · K3s · GitHub Actions · Prometheus · Grafana
